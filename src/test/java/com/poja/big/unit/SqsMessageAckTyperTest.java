...
import com.poja.big.endpoint.event.EventConsumer;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("com.poja.big.endpoint.event.gen.UuidCreated", payload);
